    ...
    return (
        <Head>
            ...
            {props.metadata.viewport && (
                <meta name="viewport" content={props.metadata.viewport} />
            )}
            ...
            <meta
                name="Classification"
                content={props.metadata.classification}
            />
            ...
            <meta
                name="identifier-URL"
                content={props.metadata.identifierURL}
            />
            ...
            <meta
                ...
                content={props.metadata.ogPhoneNumber}
            />
            <meta
                property="og:fax_number"
                content={props.metadata.ogFaxNumber}
            />
            <meta property="og:latitude" content={props.metadata.ogLatitude} />
            <meta
                property="og:longitude"
                content={props.metadata.ogLongitude}
            />
            <meta
                property="og:street-address"
                content={props.metadata.ogStreetAddress}
            />
            ...
            <meta
                ...
                content={props.metadata.ogPostalCode}
            />
            <meta
                property="og:country-name"
                content={props.metadata.ogCountryName}
            />
            ...
            <meta
                ...
                content={props.metadata.twitterCreator}
            />
            ...
            <meta
                ...
                content={props.metadata.appleMobileWebAppTitle}
            />
            <meta
                name="application-name"
                content={props.metadata.applicationName}
            />
            <meta
                name="msapplication-TileColor"
                content={props.metadata.msapplicationTileColor}
            />
            <meta
                name="msapplication-TileImage"
                content={props.metadata.msapplicationTileImage}
            />
            {props.metadata.msapplicationConfig && (
                <meta
                    name="msapplication-config"
                    content={props.metadata.msapplicationConfig}
                />
            )}
            <meta name="theme-color" content={props.metadata.themeColor} />
