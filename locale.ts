...
export const en: AppLocale = {
    ...
    darkTheme: 'Dark',
    myCV: `Updated CV`,
    softwareEngineer: 'Senior Frontend Engineer',
    discoverMyWork: `I specialize in software engineering, product development, and passionate about entrepreneurship.`,
    notLookingForJobs: 'I am not looking for a position currently',
    quickMsg: 'Quick Message',
    overview: 'Overview',
    overviewText: `I have been programming  since 2014 and I am passionate about all things technology and entrepreneurship. I graduated from King Abdulaziz University with a Bachelor of Science in Computer Science with honors. I graduated from .NET programming bootcamp by SAFCSP.`,
...
export const ar: AppLocale = {
    ...
    darkTheme: 'داكن',
    myCV: 'سيرتي الذاتية',
    softwareEngineer: 'مهندس واجهات أول',
    discoverMyWork:
    ...
    spfTitle: 'الاتحاد السعودي للطيران الشراعي',
