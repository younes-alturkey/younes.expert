...
export const en: AppLocale = {
    ...
    spfTitle: 'ShaheenSPF',
    spfText: 'ShaheenSPF company website and app',
    ...
    monshaatEci: "Monsha'at ECI",
    monshaatEciText: "Monsha'at LMS for Entrepreneurs",
    aiLLMs: 'AI and LLMs',
    gcp: 'Google Cloud Platform',
    myFux: 'MyFutureX App',
    myFuxText: 'FutureX Platform’s iOS/Android apps',
    exproAdmin: 'Nomination System',
    exproAdminText: 'Nomination system with custom workflows',
    inTheMedia: 'In The Media',
    sdcTitle: 'Soudah Development',
    ...
    twkAppsTitle: 'Tawakkalna Apps',
    twkAppsText: 'Mini apps integrated with Tawakkalna SDK',
    fuxTitle: 'FutureX Website',
    fuxText: 'Modren marketing website for FutureX',
    salla: 'Salla',
    vue: 'Vue',
    redis: 'Redis',
    python: 'Python',
...
export const ar: AppLocale = {
    ...
    spfText: 'موقع الاتحاد للطيران الشراعي وتطبيقه',
    ...
    monshaatEci: 'نظام إدارة التعلم',
    monshaatEciText: 'نظام إدارة التعلم من منشآت',
    aiLLMs: 'الذكاء الإصطناعي',
    gcp: 'منصة جوجل السحابية',
    myFux: 'ماي فوتشر إكس',
    myFuxText: 'تطبيقات منصة فوتشر إكس على الأندرويد والآيفون',
    exproAdmin: 'نظام الترشيحات',
    exproAdminText: 'نظام ترشيحات مع سير العمل المخصصة',
    inTheMedia: 'في الإعلام',
    sdcTitle: 'شركة السودة للتطوير',
    ...
    srSoftwareEngineer: 'مهندس برمجيات أول',
    twkAppsTitle: 'تطبيقات توكلنا',
    twkAppsText: 'تطبيقات متكاملة مع تواكلنا',
    fuxTitle: 'موقع فوتشر إكس',
    fuxText: 'موقع تسويقي مدرن لفوتشر إكس',
    salla: 'سلة',
    vue: 'فيو',
    redis: 'ريديس',
    python: 'بايثون',
