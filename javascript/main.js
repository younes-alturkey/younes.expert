...
const rushinit = (function () {
  ...
  //         `<div class="alert alert-danger" role="alert"><h4 class="alert-heading">There is something wrong !</h4> <hr><p class="mb-0"><ul class="errorlist">` +
  //         valid.join("") +
  //         `</ul></p></div>`;
  //     } else {
...
function scrollPortfolioIntoView() {
  document.getElementById("portfolio-section").scrollIntoView();
}

function scrollServiceIntoView() {
